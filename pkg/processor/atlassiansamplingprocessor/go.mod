...
require (
	github.com/atlassian-labs/atlassian-sampling-processor/internal/ptraceutil v0.11.108
...
replace github.com/atlassian-labs/atlassian-sampling-processor/internal/ptraceutil => ../../../internal/ptraceutil
